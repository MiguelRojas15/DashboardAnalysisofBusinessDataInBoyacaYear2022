...
# 3. GRÁFICO DE PASTEL MODERNO
plt.figure(figsize=(10, 10))
plt.gca().set_facecolor('#1a1a1a')

genero_counts = df['Genero responsable'].value_counts()

# Colores neón para el pastel
...
# 4. GRÁFICO DE BARRAS HORIZONTAL MODERNO
...
plt.title("🏙️ Top 10 Municipios con Más Empresas", fontsize=18, fontweight='bold', color='white', pad=20)
...
# 5. GRÁFICO DE DISPERSIÓN AVANZADO
plt.figure(figsize=(14, 9))
plt.gca().set_facecolor('#0a0a0a')

# Crear scatter plot con tamaños variables y colores por sector
...
# 6. BONUS: GRÁFICO DE CORRELACIÓN MODERNO
